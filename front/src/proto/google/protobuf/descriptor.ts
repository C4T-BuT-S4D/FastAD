...
export const FeatureSet_EnumType = { ENUM_TYPE_UNKNOWN: 0, OPEN: 1, CLOSED: 2 } as const;
...
export const FeatureSet_RepeatedFieldEncoding = { REPEATED_FIELD_ENCODING_UNKNOWN: 0, PACKED: 1, EXPANDED: 2 } as const;
...
export const FeatureSet_Utf8Validation = { UTF8_VALIDATION_UNKNOWN: 0, VERIFY: 2, NONE: 3 } as const;
...
export const FeatureSet_MessageEncoding = { MESSAGE_ENCODING_UNKNOWN: 0, LENGTH_PREFIXED: 1, DELIMITED: 2 } as const;
...
export const FeatureSet_JsonFormat = { JSON_FORMAT_UNKNOWN: 0, ALLOW: 1, LEGACY_BEST_EFFORT: 2 } as const;
...
export const ExtensionRangeOptions_Declaration: MessageFns<ExtensionRangeOptions_Declaration> = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<ExtensionRangeOptions_Declaration | ExtensionRangeOptions_Declaration[]>
      | Iterable<ExtensionRangeOptions_Declaration | ExtensionRangeOptions_Declaration[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of (pkt as any)) {
...
export const FieldOptions_EditionDefault: MessageFns<FieldOptions_EditionDefault> = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FieldOptions_EditionDefault | FieldOptions_EditionDefault[]>
      | Iterable<FieldOptions_EditionDefault | FieldOptions_EditionDefault[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of (pkt as any)) {
...
export const FieldOptions_FeatureSupport: MessageFns<FieldOptions_FeatureSupport> = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FieldOptions_FeatureSupport | FieldOptions_FeatureSupport[]>
      | Iterable<FieldOptions_FeatureSupport | FieldOptions_FeatureSupport[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of (pkt as any)) {
...
export const FeatureSetDefaults: MessageFns<FeatureSetDefaults> = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FeatureSetDefaults | FeatureSetDefaults[]>
      | Iterable<FeatureSetDefaults | FeatureSetDefaults[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of (pkt as any)) {
...
export const FeatureSetDefaults_FeatureSetEditionDefault: MessageFns<FeatureSetDefaults_FeatureSetEditionDefault> = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FeatureSetDefaults_FeatureSetEditionDefault | FeatureSetDefaults_FeatureSetEditionDefault[]>
      | Iterable<FeatureSetDefaults_FeatureSetEditionDefault | FeatureSetDefaults_FeatureSetEditionDefault[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of (pkt as any)) {

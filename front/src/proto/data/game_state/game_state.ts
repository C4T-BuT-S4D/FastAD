...
export namespace GameStatus {
  export type GAME_STATUS_UNSPECIFIED = typeof GameStatus.GAME_STATUS_UNSPECIFIED;
  export type GAME_STATUS_NOT_STARTED = typeof GameStatus.GAME_STATUS_NOT_STARTED;
  export type GAME_STATUS_RUNNING = typeof GameStatus.GAME_STATUS_RUNNING;
  export type GAME_STATUS_PAUSED = typeof GameStatus.GAME_STATUS_PAUSED;
  export type GAME_STATUS_FINISHED = typeof GameStatus.GAME_STATUS_FINISHED;
}
...
export function gameStatusFromJSON(object: any): GameStatus {
  switch (object) {
    ...
    case "GAME_STATUS_NOT_STARTED":
      return GameStatus.GAME_STATUS_NOT_STARTED;
    case 2:
    case "GAME_STATUS_RUNNING":
      return GameStatus.GAME_STATUS_RUNNING;
    case 3:
    case "GAME_STATUS_PAUSED":
      return GameStatus.GAME_STATUS_PAUSED;
    case 4:
    case "GAME_STATUS_FINISHED":
      return GameStatus.GAME_STATUS_FINISHED;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum GameStatus");
  }
}
...
export function gameStatusToJSON(object: GameStatus): string {
  switch (object) {
    ...
    case GameStatus.GAME_STATUS_NOT_STARTED:
      return "GAME_STATUS_NOT_STARTED";
    case GameStatus.GAME_STATUS_RUNNING:
      return "GAME_STATUS_RUNNING";
    case GameStatus.GAME_STATUS_PAUSED:
      return "GAME_STATUS_PAUSED";
...
export const GameState: MessageFns<GameState> = {
  encode(message: GameState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.runningRound !== "0") {
      writer.uint32(56).uint64(message.runningRound);
    }
    if (message.runningRoundStart !== undefined) {
      Timestamp.encode(toTimestamp(message.runningRoundStart), writer.uint32(66).fork()).join();
    }
    if (message.hardness !== 0) {
      writer.uint32(73).double(message.hardness);
    }
    if (message.inflation !== false) {
      writer.uint32(80).bool(message.inflation);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.totalRounds = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 7: {
          ...
          message.runningRound = reader.uint64().toString();
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromJSON(object: any): GameState {
    return {
      ...
      endTime: isSet(object.endTime)
        ...
        : undefined,
      totalRounds: isSet(object.totalRounds)
        ? globalThis.String(object.totalRounds)
        : isSet(object.total_rounds)
        ? globalThis.String(object.total_rounds)
        : "0",
      status: isSet(object.status) ? gameStatusFromJSON(object.status) : 0,
      flagLifetimeRounds: isSet(object.flagLifetimeRounds)
        ? globalThis.String(object.flagLifetimeRounds)
        : isSet(object.flag_lifetime_rounds)
        ? globalThis.String(object.flag_lifetime_rounds)
        : "0",
      roundDuration: isSet(object.roundDuration)
        ? Duration.fromJSON(object.roundDuration)
        : isSet(object.round_duration)
        ? Duration.fromJSON(object.round_duration)
        : undefined,
      runningRound: isSet(object.runningRound)
        ? globalThis.String(object.runningRound)
        : isSet(object.running_round)
        ? globalThis.String(object.running_round)
        : "0",
      runningRoundStart: isSet(object.runningRoundStart)
        ? fromJsonTimestamp(object.runningRoundStart)
        : isSet(object.running_round_start)
        ? fromJsonTimestamp(object.running_round_start)
        : undefined,
...
export const UpdateRequest: MessageFns<UpdateRequest> = {
  encode(message: UpdateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hardness !== undefined) {
      writer.uint32(57).double(message.hardness);
    }
    if (message.inflation !== undefined) {
      writer.uint32(64).bool(message.inflation);
    }
    return writer;
  },

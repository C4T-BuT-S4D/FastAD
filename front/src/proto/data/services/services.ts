...
export const Service: MessageFns<Service> = {
  ...
  fromJSON(object: any): Service {
    return {
      ...
      defaultScore: isSet(object.defaultScore)
        ? globalThis.Number(object.defaultScore)
        : isSet(object.default_score)
        ? globalThis.Number(object.default_score)
        : 0,
...
export const Service_Checker: MessageFns<Service_Checker> = {
  ...
  fromJSON(object: any): Service_Checker {
    return {
      ...
      defaultTimeout: isSet(object.defaultTimeout)
        ? Duration.fromJSON(object.defaultTimeout)
        : isSet(object.default_timeout)
        ? Duration.fromJSON(object.default_timeout)
        : undefined,
  ...
  fromJSON(object: any): Service_Checker_Action {
    return {
      ...
      runCount: isSet(object.runCount)
        ? globalThis.String(object.runCount)
        : isSet(object.run_count)
        ? globalThis.String(object.run_count)
        : "0",
    };
  },
...
function createBaseUpdateRequest(): UpdateRequest {
  return { id: "0", disabled: undefined };
}

...
export const SubmitFlagsRequest: MessageFns<SubmitFlagsRequest> = {
  ...
  fromJSON(object: any): SubmitFlagsRequest {
    return {
      ...
      teamToken: isSet(object.teamToken)
        ? globalThis.String(object.teamToken)
        : isSet(object.team_token)
        ? globalThis.String(object.team_token)
        : "",
    };
  },
...
export const FlagResponse: MessageFns<FlagResponse> = {
  ...
  fromJSON(object: any): FlagResponse {
    return {
      ...
      victimId: isSet(object.victimId)
        ? globalThis.String(object.victimId)
        : isSet(object.victim_id)
        ? globalThis.String(object.victim_id)
        : "0",
      serviceId: isSet(object.serviceId)
        ...
        : "0",
      attackerDelta: isSet(object.attackerDelta)
        ? globalThis.Number(object.attackerDelta)
        : isSet(object.attacker_delta)
        ? globalThis.Number(object.attacker_delta)
        : 0,
      victimDelta: isSet(object.victimDelta)
        ? globalThis.Number(object.victimDelta)
        : isSet(object.victim_delta)
        ? globalThis.Number(object.victim_delta)
        : 0,
    };
  },
  ...
  fromJSON(object: any): AttackNotification {
    return {
      attackerId: isSet(object.attackerId)
        ? globalThis.String(object.attackerId)
        : isSet(object.attacker_id)
        ? globalThis.String(object.attacker_id)
        : "0",
      victimId: isSet(object.victimId)
        ? globalThis.String(object.victimId)
        : isSet(object.victim_id)
  ...
  fromJSON(object: any): State {
    return {
      teamServices: globalThis.Array.isArray(object?.teamServices)
        ...
        : globalThis.Array.isArray(object?.team_services)
        ? object.team_services.map((e: any) => State_TeamService.fromJSON(e))
        : [],
    };
  },

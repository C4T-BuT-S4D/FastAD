...
type State_TeamService struct {
	...
	StolenFlags   int64                  `protobuf:"varint,4,opt,name=stolen_flags,json=stolenFlags,proto3" json:"stolen_flags,omitempty"`
	LostFlags     int64                  `protobuf:"varint,5,opt,name=lost_flags,json=lostFlags,proto3" json:"lost_flags,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *State_TeamService) GetStolenFlags() int64 {
	if x != nil {
...
func (x *State_TeamService) GetLostFlags() int64 {
	if x != nil {
		return x.LostFlags
	}
	return 0
...
var file_receiver_receiver_proto_rawDesc = []byte{
	...
	0x0a, 0x0c, 0x73, 0x74, 0x6f, 0x6c, 0x65, 0x6e, 0x5f, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x73, 0x74, 0x6f, 0x6c, 0x65, 0x6e, 0x46, 0x6c, 0x61, 0x67,
	0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x6c, 0x6f, 0x73, 0x74, 0x5f, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x6c, 0x6f, 0x73, 0x74, 0x46, 0x6c, 0x61, 0x67, 0x73,

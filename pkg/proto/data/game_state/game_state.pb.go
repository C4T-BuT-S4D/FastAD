...
type GameState struct {
	...
	FlagLifetimeRounds int32                  `protobuf:"varint,5,opt,name=flag_lifetime_rounds,json=flagLifetimeRounds,proto3" json:"flag_lifetime_rounds,omitempty"`
	...
	RunningRound       int32                  `protobuf:"varint,8,opt,name=running_round,json=runningRound,proto3" json:"running_round,omitempty"`
...
func (x *GameState) GetTotalRounds() int32 {
	if x != nil {
...
func (x *UpdateRequest) GetTotalRounds() int32 {
	if x != nil {
		return x.TotalRounds
	}
	return 0
...
func (x *UpdateRequest) GetFlagLifetimeRounds() int32 {
	if x != nil {
		return x.FlagLifetimeRounds
	}
	return 0
...
func (x *UpdateRoundRequest) GetRunningRound() int32 {
	if x != nil {
		return x.RunningRound
	}
	return 0
...
var file_data_game_state_game_state_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x52, 0x6f, 0x75,
	...
	0x6e, 0x64, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x12, 0x66, 0x6c, 0x61, 0x67, 0x4c,
	...
	0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x52, 0x6f,
	...
	0x01, 0x28, 0x05, 0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x73,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x12, 0x66, 0x6c, 0x61, 0x67, 0x4c, 0x69, 0x66, 0x65,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67,
...
func file_data_game_state_game_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_game_state_game_state_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_game_state_game_state_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {

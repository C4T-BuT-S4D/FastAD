...
var file_data_game_state_game_state_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_data_game_state_game_state_proto_depIdxs = []int32{
	4, // 0: data.game_state.GameState.start_time:type_name -> google.protobuf.Timestamp
	4, // 1: data.game_state.GameState.end_time:type_name -> google.protobuf.Timestamp
	5, // 2: data.game_state.GameState.round_duration:type_name -> google.protobuf.Duration
	0, // 3: data.game_state.GameState.mode:type_name -> data.game_state.GameMode
	4, // 4: data.game_state.GameState.running_round_start:type_name -> google.protobuf.Timestamp
	6, // 5: data.game_state.GetRequest.version:type_name -> data.version.Version
	1, // 6: data.game_state.GetResponse.game_state:type_name -> data.game_state.GameState
	6, // 7: data.game_state.GetResponse.version:type_name -> data.version.Version

...
var file_data_game_state_game_state_service_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd0, 0x02,
	...
	0x58, 0x0a, 0x0b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x23,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	,
...
var file_data_game_state_game_state_service_proto_goTypes = []any{
	...
	(*FinishGameRequest)(nil),   // 3: data.game_state.FinishGameRequest
	(*GetResponse)(nil),         // 4: data.game_state.GetResponse
	(*UpdateResponse)(nil),      // 5: data.game_state.UpdateResponse
	(*UpdateRoundResponse)(nil), // 6: data.game_state.UpdateRoundResponse
	(*FinishGameResponse)(nil),  // 7: data.game_state.FinishGameResponse
}
var file_data_game_state_game_state_service_proto_depIdxs = []int32{
	...
	3, // 3: data.game_state.GameStateService.FinishGame:input_type -> data.game_state.FinishGameRequest
	4, // 4: data.game_state.GameStateService.Get:output_type -> data.game_state.GetResponse
	5, // 5: data.game_state.GameStateService.Update:output_type -> data.game_state.UpdateResponse
	6, // 6: data.game_state.GameStateService.UpdateRound:output_type -> data.game_state.UpdateRoundResponse
	7, // 7: data.game_state.GameStateService.FinishGame:output_type -> data.game_state.FinishGameResponse

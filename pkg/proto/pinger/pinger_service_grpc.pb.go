...
func (c *pingerServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, PingerService_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPingerServiceServer must be embedded to have
...
func (UnimplementedPingerServiceServer) testEmbeddedByValue()                       {}
...
func RegisterPingerServiceServer(s grpc.ServiceRegistrar, srv PingerServiceServer) {
	// If the following call pancis, it indicates UnimplementedPingerServiceServer was
...
var PingerService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pinger/pinger_service.proto",
}
